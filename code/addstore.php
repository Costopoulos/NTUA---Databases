<?php 
	...
	//		$phone=mysqli_real_escape_string($conn, $_POST['phone']);
			...
			$addtosql="INSERT INTO store(working_hours, address, square_meters, /*product_categories*/ postal_code, phone, city) VALUES('$working_hours', '$address', '$square_meters', /*'$product_categories'*/'$postal_code', /*'$phone',*/ '$city')";
...
<html>
	...
	<section class="container grey-text" >
		<h4 class="center">Add a Store</h4>
		<form class="white" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST"> 
			...
			<input type="text" name="working_hours" value="<?php echo htmlspecialchars($working_hours) ?>"> <!--This way we store the inputs of the user if he fucks up -->
			...
			<input type="text" name="square_meters" value="<?php echo htmlspecialchars($square_meters) ?>"> <!--This way we store the inputs of the user if he fucks up -->
		...
		<!--	<label>Product Categories:</label>
			...
			<input type="text" name="postal code" value="<?php echo htmlspecialchars($postal_code) ?>">
